...
pub unsafe extern "C" fn getrlimit64(resource: ::c_int, rlim: *mut ::rlimit64) -> ::c_int {
    ...
    crate::unix::platform::dragonos::pal::relibc_adapter::pal::getrlimit(resource, rlim as *mut _)
}
...
pub unsafe extern "C" fn prlimit64(
    ...
    crate::unix::platform::prlimit(pid, resource, new_limit as *mut _, old_limit as *mut _)
}
...
pub unsafe extern "C" fn setrlimit64(resource: ::c_int, rlim: *const ::rlimit64) -> ::c_int {
    crate::unix::platform::setrlimit(resource, rlim as *mut _)
}
