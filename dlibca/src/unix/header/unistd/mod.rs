...
pub extern "C" fn alarm(seconds: ::c_uint) -> ::c_uint {
    ...
    let secs = if ::setitimer(sys_time::ITIMER_REAL, &timer, &mut timer) < 0 {
        0
    } else {
...
//     platform::pal::chown(path, owner, group)
// }

// #[no_mangle]
// pub extern "C" fn close(fildes: ::c_int) -> ::c_int {
//     platform::pal::close(fildes)
// }
...
//     platform::pal::dup(fildes)
// }

// #[no_mangle]
// pub extern "C" fn dup2(fildes: ::c_int, fildes2: ::c_int) -> ::c_int {
//     platform::pal::dup2(fildes, fildes2)
// }
...
pub unsafe extern "C" fn execv(path: *const ::c_char, argv: *const *const ::c_char) -> ::c_int {
    ::execve(path, argv, platform::environ as *const *const ::c_char)
}
...
//     envp: *const *mut ::c_char,
// ) -> ::c_int {
//     platform::pal::execve(path, argv as *const *const i8, envp as *const *const i8)
// }
...
//     platform::pal::fchown(fildes, owner, group)
// }

// #[no_mangle]
// pub extern "C" fn fchdir(fildes: ::c_int) -> ::c_int {
//     platform::pal::fchdir(fildes)
// }
...
//     platform::pal::fsync(fildes)
// }

// #[no_mangle]
// pub extern "C" fn ftruncate(fildes: ::c_int, length: ::off_t) -> ::c_int {
//     platform::pal::ftruncate(fildes, length)
// }
...
pub extern "C" fn getcwd(mut buf: *mut ::c_char, mut size: ::size_t) -> *mut ::c_char {
    ...
    let ret = platform::pal::getcwd(buf, size);
    if ret.is_null() {
        return ptr::null_mut();
    }
...
//     platform::pal::getegid()
// }

// #[no_mangle]
// pub extern "C" fn geteuid() -> ::uid_t {
//     platform::pal::geteuid()
// }
...
//     platform::pal::getpgid(pid)
// }

#[no_mangle]
pub extern "C" fn getpgrp() -> ::pid_t {
    platform::pal::getpgid(platform::pal::getpid())
}
...
//     platform::pal::getppid()
// }

// #[no_mangle]
// pub extern "C" fn getsid(pid: ::pid_t) -> ::pid_t {
//     platform::pal::getsid(pid)
// }
...
//     platform::pal::lchown(path, owner, group)
// }
...
//     platform::pal::lseek(fildes, offset, whence)
// }
...
//     platform::pal::pipe2(fildes, flags)
// }
...
//     trace_expr!(
//         platform::pal::read(fildes, buf as *mut ::c_void,nbyte),
//         "read({}, {:p}, {})",
//         fildes,
//         buf,
//         nbyte
...
//     bufsize: ::size_t,
// ) -> ::ssize_t {
//     platform::pal::readlink(path, buf,bufsize)
// }

// #[no_mangle]
// pub unsafe extern "C" fn rmdir(path: *const ::c_char) -> ::c_int {
//     platform::pal::rmdir(path)
// }

#[no_mangle]
pub extern "C" fn setgid(gid: ::gid_t) -> ::c_int {
    platform::pal::setregid(gid, gid)
}

// #[no_mangle]
// pub extern "C" fn setpgid(pid: ::pid_t, pgid: ::pid_t) -> ::c_int {
//     platform::pal::setpgid(pid, pgid)
// }

#[no_mangle]
pub unsafe extern "C" fn setpgrp() -> ::pid_t {
    ::setpgid(0, 0)
}

// #[no_mangle]
// pub extern "C" fn setregid(rgid: ::gid_t, egid: ::gid_t) -> ::c_int {
//     platform::pal::setregid(rgid, egid)
// }

// #[no_mangle]
// pub extern "C" fn setreuid(ruid: ::uid_t, euid: ::uid_t) -> ::c_int {
//     platform::pal::setreuid(ruid, euid)
// }
...
pub extern "C" fn sleep(seconds: ::c_uint) -> ::c_uint {
    ...
    platform::pal::nanosleep(&rqtp, rmtp);
    0
}
...
//     platform::pal::symlink(path1, path2)
// }
...
pub extern "C" fn tcgetpgrp(fd: ::c_int) -> ::pid_t {
    let mut pgrp = 0;
    if unsafe { ioctl(fd, TIOCGPGRP, &mut pgrp as *mut ::pid_t as *mut ::c_void) } < 0 {
        return -1;
    }
    pgrp
}
...
pub extern "C" fn tcsetpgrp(fd: ::c_int, pgrp: ::pid_t) -> ::c_int {
    if unsafe { ioctl(fd, TIOCSPGRP, &pgrp as *const ::pid_t as *mut ::c_void) } < 0 {
        return -1;
    }
    pgrp
}
...
pub extern "C" fn truncate(path: *const ::c_char, length: ::off_t) -> ::c_int {
    let fd = platform::pal::open(path, ::O_WRONLY, 0);
    if fd < 0 {
        return -1;
    }
...
pub extern "C" fn ualarm(usecs: ::useconds_t, interval: ::useconds_t) -> ::useconds_t {
    ...
    let errno_backup = unsafe { platform::errno };
    let ret = if ::setitimer(sys_time::ITIMER_REAL, &timer, &mut timer) < 0 {
        0
    } else {
...
//     platform::pal::write(fildes, buf, nbyte)
// }
