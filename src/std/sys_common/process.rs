...
use crate::std::fmt;
use crate::std::io;
use crate::std::sys::pipe::read2;
use crate::std::sys::process::{EnvKey, ExitStatus, Process, StdioPipes};
...
/// [`Command::get_envs`][crate::std::process::Command::get_envs]. See its
/// documentation for more.
#[must_use = "iterators are lazy and do nothing unless consumed"]
#[derive(Debug)]
pub struct CommandEnvs<'a> {
    iter: crate::std::collections::btree_map::Iter<'a, EnvKey, Option<OsString>>,
}
