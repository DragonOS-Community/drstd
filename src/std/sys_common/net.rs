...
use crate::std::cmp;
use crate::std::fmt;
use crate::std::io::{self, BorrowedCursor, ErrorKind, IoSlice, IoSliceMut};
use crate::std::mem;
...
cfg_if::cfg_if! {
    if #[cfg(any(
        ...
        use dlibc::IPV6_JOIN_GROUP as IPV6_ADD_MEMBERSHIP;
        use dlibc::IPV6_LEAVE_GROUP as IPV6_DROP_MEMBERSHIP;
    } else {
        use dlibc::IPV6_ADD_MEMBERSHIP;
        use dlibc::IPV6_DROP_MEMBERSHIP;
    }
}

cfg_if::cfg_if! {
    if #[cfg(any(
        target_os = "linux", target_os = "android",target_os = "dragonos",
        target_os = "dragonfly", target_os = "freebsd",
...
fn to_ipv6mr_interface(value: u32) -> crate::std::ffi::c_uint {
    value as crate::std::ffi::c_uint
}
