...
use crate::std::sys;
use crate::std::sys::path::{is_sep_byte, is_verbatim_sep, parse_prefix, MAIN_SEP_STR};
...
pub const MAIN_SEPARATOR: char = crate::std::sys::path::MAIN_SEP;

/// The primary separator of path components for the current platform.
///
/// For example, `/` on Unix and `\` on Windows.
pub const MAIN_SEPARATOR_STR: &str = crate::std::sys::path::MAIN_SEP_STR;
...
/// rules but unlike [`canonicalize`][crate::std::fs::canonicalize] this does not
/// resolve symlinks and may succeed even if the path does not exist.
///
/// If the `path` is empty or getting the
/// [current directory][crate::std::env::current_dir] fails then an error will be
/// returned.
///
/// # Examples
///
