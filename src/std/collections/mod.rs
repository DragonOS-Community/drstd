...
//! [`collect`][crate::std::iter::Iterator::collect] or
//! [`extend`][crate::std::iter::Extend::extend] can be called to
...
pub use alloc::collections::TryReserveErrorKind;
