...
// use crate::std::fmt;
// use crate::std::hash::{BuildHasher, Hash};
// use crate::std::iter::{Chain, FusedIterator};
// use crate::std::ops::{BitAnd, BitOr, BitXor, Sub};
...
// /// ```
// ///
// /// [hash set]: crate::std::collections#use-the-set-variant-of-any-of-these-maps-when
