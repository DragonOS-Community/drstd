...
// ///
// /// [hash map]: crate::std::collections#use-a-hashmap-when
...
//     ///
//     /// [module-level documentation]: crate::std::collections#insert-and-complex-keys
//     ///
//     /// # Examples
//     ///
//     /// ```
...
// #[inline]
// fn map_entry<'a, K: 'a, V: 'a, S: 'a>(raw: base::Entry<'a, K, V,S>) -> Entry<'a, K, V> {
//     match raw {
