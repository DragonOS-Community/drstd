...
use crate::std::assert_matches::assert_matches;
use crate::std::cell::RefCell;
use crate::std::test_helpers::test_rng;
use rand::Rng;
use realstd::collections::TryReserveErrorKind::*;

// https://github.com/rust-lang/rust/issues/62301
fn _assert_hashmap_is_unwind_safe() {
    fn assert_unwind_safe<T: crate::std::panic::UnwindSafe>() {}
    assert_unwind_safe::<HashMap<(), crate::std::cell::UnsafeCell<()>>>();
}
...
mod test_extract_if {
    ...
    fn consuming_nothing() {
        ...
        assert!(map.extract_if(|_, _| false).eq_sorted(crate::std::iter::empty()));
        assert_eq!(map.len(), 3);
    }
    ...
    fn mutating_and_keeping() {
        ...
        assert!(
            ...
            .eq_sorted(crate::std::iter::empty())
        );
