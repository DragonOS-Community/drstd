...
use crate::std::io::{BorrowedBuf, ErrorKind, IoSlice, IoSliceMut};
use crate::std::mem::MaybeUninit;
use crate::std::net::test::{next_test_ip4, next_test_ip6};
use crate::std::net::*;
...
fn debug() {
    ...
    #[cfg(target_env = "sgx")]
    use crate::std::os::fortanix_sgx::io::AsRawFd;
    #[cfg(unix)]
    ...
    #[cfg(windows)]
    fn render_inner(addr: &dyn crate::std::os::windows::io::AsRawSocket) -> impl fmt::Debug {
        addr.as_raw_socket()
    }
