...
/// silently ignored.
///
/// [`FromStr`]: crate::std::str::FromStr "std::str::FromStr"
/// [`TcpStream`]: crate::std::net::TcpStream "net::TcpStream"
/// [`to_socket_addrs`]: ToSocketAddrs::to_socket_addrs
/// [`UdpSocket`]: crate::std::net::UdpSocket "net::UdpSocket"
///
/// # Examples
///
...
/// ```
///
/// [`TcpStream::connect`]: crate::std::net::TcpStream::connect
