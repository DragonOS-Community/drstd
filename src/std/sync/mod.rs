...
//! [compiler fences]: crate::std::sync::atomic::compiler_fence
//! [out-of-order]: https://en.wikipedia.org/wiki/Out-of-order_execution
//! [superscalar]: https://en.wikipedia.org/wiki/Superscalar_processor
//! [memory fences]: crate::std::sync::atomic::fence
//! [atomic operations]: crate::std::sync::atomic
//!
...
//!   a mutex.
//!
//! [`Arc`]: crate::std::sync::Arc
//! [`Barrier`]: crate::std::sync::Barrier
//! [`Condvar`]: crate::std::sync::Condvar
//! [`mpsc`]: crate::std::sync::mpsc
//! [`Mutex`]: crate::std::sync::Mutex
//! [`Once`]: crate::std::sync::Once
