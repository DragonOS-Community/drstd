...
use crate::std::sys::os_str::{Buf, Slice};
...
impl crate::std::sealed::Sealed for OsString {}
...
/// Allows extension traits within `std`.
impl crate::std::sealed::Sealed for OsStr {}
...
impl<'a> TryFrom<&'a OsStr> for &'a str {
    type Error = crate::std::str::Utf8Error;
