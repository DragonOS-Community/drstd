...
/// root of the current crate. For instance, `crate::std::foo::bar` refers to the name `bar` inside the
...
/// ## Literal Example:
///
///    * `pub(in crate::std::outer_mod) fn outer_mod_visible_fn() {}` - fn is visible in `outer_mod`
///
...
///
/// Using path qualifiers like [`crate`], [`super`] or [`self`] is supported: `use crate::std::a::b;`.
///
...
/// as can be seen with the [`Cow`](crate::std::borrow::Cow) type from the standard
/// library:
///
/// ```rust
/// # #![allow(dead_code)]
