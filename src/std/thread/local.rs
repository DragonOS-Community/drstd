...
use crate::std::cell::{Cell, RefCell};
...
/// [`JoinHandle::join`]: crate::std::thread::JoinHandle::join
/// [`with`]: LocalKey::with
...
/// [need to be dropped][crate::std::mem::needs_drop], this can enable an
...
/// information.
///
/// [`std::thread::LocalKey`]: crate::std::thread::LocalKey
#[macro_export]
...
macro_rules! thread_local {
    ...
    ($(#[$attr:meta])* $vis:vis static $name:ident: $t:ty = const { $init:expr }; $($rest:tt)*) => (
        $crate::std::thread::local_impl::thread_local_inner!($(#[$attr])* $vis $name, $t, const $init);
        $crate::std::thread_local!($($rest)*);
    );
    ...
    ($(#[$attr:meta])* $vis:vis static $name:ident: $t:ty = $init:expr; $($rest:tt)*) => (
        $crate::std::thread::local_impl::thread_local_inner!($(#[$attr])* $vis $name, $t, $init);
        //$crate::std::thread_local!($($rest)*);
    );
