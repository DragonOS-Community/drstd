...
pub trait CommandExt: Sealed {
    ...
    /// `Command` calls [`std::panic::always_abort`](crate::std::panic::always_abort)
...
impl CommandExt for process::Command {
    ...
    fn exec(&mut self) -> io::Error {
        // NOTE: This may *not* be safe to call after `dlibc::fork`, because it
...
/// [`ExitStatus::code()`](crate::std::process::ExitStatus::code).  It represents **any wait status**
