...
use crate::std::os::android::net::SocketAddrExt;

#[cfg(target_os = "linux")]
use crate::std::os::linux::net::SocketAddrExt;
...
fn test_unix_stream_peek() {
    let (txdone, rxdone) = crate::std::sync::mpsc::channel();
...
fn test_send_vectored_with_ancillary_to_unix_datagram() {
    fn getpid() -> dlibc::pid_t {
        unsafe { dlibc::getpid() }
    }

    fn getuid() -> dlibc::uid_t {
        unsafe { dlibc::getuid() }
    }

    fn getgid() -> dlibc::gid_t {
        unsafe { dlibc::getgid() }
    }
