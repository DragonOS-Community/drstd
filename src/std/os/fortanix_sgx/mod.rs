...
pub mod usercalls {
    pub use crate::std::sys::abi::usercalls::*;

    /// Primitives for allocating memory in userspace as well as copying data
    /// to and from user memory.
    pub mod alloc {
        pub use crate::std::sys::abi::usercalls::alloc::*;
    }

    /// Lowest-level interfaces to usercalls and usercall ABI type definitions.
    pub mod raw {
        pub use crate::std::sys::abi::usercalls::raw::{
        ...
        pub use crate::std::sys::abi::usercalls::raw::{do_usercall, Usercalls as UsercallNrs};
        pub use crate::std::sys::abi::usercalls::raw::{Register, RegisterArgument, ReturnValue};

        // fortanix-sgx-abi re-exports
        pub use crate::std::sys::abi::usercalls::raw::Error;
        pub use crate::std::sys::abi::usercalls::raw::{
            ByteBuffer, Cancel, FifoDescriptor, Return, Usercall,
        };
        pub use crate::std::sys::abi::usercalls::raw::{Fd, Result, Tcs};
        pub use crate::std::sys::abi::usercalls::raw::{
...
pub mod thread {
    pub use crate::std::sys::abi::thread::current;
}
