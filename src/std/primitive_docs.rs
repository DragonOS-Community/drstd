...
///
/// unsafe {
///     let my_num: *mut i32 = dlibc::malloc(mem::size_of::<i32>()) as *mut i32;
///     if my_num.is_null() {
///         panic!("failed to allocate memory");
///     }
///     dlibc::free(my_num as *mut dlibc::c_void);
/// }
/// ```
///
...
/// [TryFrom](crate::std::convert::TryFrom) returning:
///
...
///
/// *[See also the `std::slice` module](crate::std::slice).*
///
...
/// String slices.
///
/// *[See also the `std::str` module](crate::std::str).*
///
...
///
/// *[See also the `std::f32::consts` module](crate::std::f32::consts).*
///
...
///
/// *[See also the `std::f64::consts` module](crate::std::f64::consts).*
///
/// [`f32`]: prim@f32
