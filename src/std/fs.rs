...
use crate::std::fmt;
use crate::std::io::{self, BorrowedCursor, IoSlice, IoSliceMut, Read, Seek, SeekFrom, Write};
use crate::std::path::{Path, PathBuf};
use crate::std::sealed::Sealed;
use crate::std::sync::Arc;
use crate::std::sys::fs as fs_imp;
...
///
/// [`PermissionsExt`]: crate::std::os::unix::fs::PermissionsExt
...
impl File {
    ...
    /// Also, [`std::io::ErrorKind::InvalidInput`](crate::std::io::ErrorKind::InvalidInput)
...
///
/// [`std::os::unix::fs::symlink`]: crate::std::os::unix::fs::symlink
/// [`std::os::windows::fs::symlink_file`]: crate::std::os::windows::fs::symlink_file
/// [`symlink_dir`]: crate::std::os::windows::fs::symlink_dir
///
/// # Examples
///
/// ```no_run
...
/// ```
///
/// [`Path::exists`]: crate::std::path::Path::exists
