...
//! [`TcpStream`]: crate::std::net::TcpStream
//! [`io::stdout`]: stdout
...
use crate::std::str;
use crate::std::sys;
use crate::std::sys_common::memchr;
...
const DEFAULT_BUF_SIZE: usize = crate::std::sys_common::io::DEFAULT_BUF_SIZE;
...
pub trait Read {
    ...
    ///
    /// [`MaybeUninit<T>`]: crate::std::mem::MaybeUninit
    ///
    /// # Errors
    ///
    ...
    ///
    /// [`Item`]: Iterator::Item
    /// [`File`]: crate::std::fs::File "fs::File"
    /// [Result]: crate::std::result::Result "Result"
