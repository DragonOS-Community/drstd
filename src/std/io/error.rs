...
/// [`Write`]: crate::std::io::Write
/// [`Seek`]: crate::std::io::Seek
pub struct Error {
    repr: Repr,
}
...
pub(crate) macro const_io_error($kind:expr, $message:expr $(,)?) {
    $crate::std::io::error::Error::from_static_message({
        const MESSAGE_DATA: $crate::std::io::error::SimpleMessage =
            $crate::std::io::error::SimpleMessage::new($kind, $message);
        &MESSAGE_DATA
    })
}
