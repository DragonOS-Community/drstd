...
use crate::std::str;
use crate::std::sys::pipe::{read2, AnonPipe};
use crate::std::sys::process as imp;
pub use crate::std::sys_common::process::CommandEnvs;
...
impl crate::std::sealed::Sealed for Child {}
...
/// Allows extension traits within `std`.
impl crate::std::sealed::Sealed for Command {}
...
/// `ExitStatusError` using their implementations of [`Display`](crate::std::fmt::Display).
///
...
/// Allows extension traits within `std`.
impl crate::std::sealed::Sealed for ExitStatus {}
...
impl ExitStatus {
    ...
    /// [`ExitStatusExt`](crate::std::os::unix::process::ExitStatusExt) is an
...
/// Allows extension traits within `std`.
impl crate::std::sealed::Sealed for ExitStatusError {}
...
impl ExitStatusError {
    ...
    /// [`ExitStatusExt`](crate::std::os::unix::process::ExitStatusExt).
    ///
...
impl crate::std::error::Error for ExitStatusError {}
...
/// Allows extension traits within `std`.
impl crate::std::sealed::Sealed for ExitCode {}
...
pub fn exit(code: i32) -> ! {
    crate::std::rt::cleanup();
    crate::std::sys::os::exit(code)
}
...
/// ```
///
/// [panic hook]: crate::std::panic::set_hook
#[cold]
pub fn abort() -> ! {
    crate::std::sys::abort_internal();
}
...
/// to an integer.
///
/// The default implementations are returning `dlibc::EXIT_SUCCESS` to indicate
/// a successful execution. In case of a failure, `dlibc::EXIT_FAILURE` is returned.
///
