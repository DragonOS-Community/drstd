...
use crate::std::io::{BorrowedCursor, IoSlice, IoSliceMut, SeekFrom};
use crate::std::os::hermit::io::{AsFd, AsRawFd, BorrowedFd, FromRawFd, IntoRawFd, RawFd};
...
use crate::std::sys::hermit::fd::FileDesc;
...
pub use crate::std::sys_common::fs::{copy, try_exists};
...
impl File {
    ...
    pub fn read_vectored(&self, bufs: &mut [IoSliceMut<'_>]) -> io::Result<usize> {
        crate::std::io::default_read_vectored(|buf| self.read(buf), bufs)
    }
    ...
    pub fn read_buf(&self, cursor: BorrowedCursor<'_>) -> io::Result<()> {
        crate::std::io::default_read_buf(|buf| self.read(buf), cursor)
    }
    ...
    pub fn write_vectored(&self, bufs: &[IoSlice<'_>]) -> io::Result<usize> {
        crate::std::io::default_write_vectored(|buf| self.write(buf), bufs)
    }
