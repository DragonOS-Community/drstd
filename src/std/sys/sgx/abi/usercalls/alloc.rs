...
use crate::std::arch::asm;
use crate::std::cell::UnsafeCell;
use crate::std::cmp;
use crate::std::mem;
use crate::std::ops::{CoerceUnsized, Deref, DerefMut, Index, IndexMut};
use crate::std::ptr::{self, NonNull};
use crate::std::slice;
use crate::std::slice::SliceIndex;
    ...
    T: UserSafe,
{
    ...
    fn new_uninit_bytes(size: usize) -> Self {
        unsafe {
            ...
            if let Ok(v) = crate::std::panic::catch_unwind(|| T::from_raw_sized(ptr, size)) {
