...
use crate::std::ptr;
use crate::std::sys::sgx::abi::mem as sgx_mem;
...
pub unsafe extern "C" fn __rust_c_alloc(size: usize, align: usize) -> *mut u8 {
    unsafe { crate::std::alloc::alloc(Layout::from_size_align_unchecked(size, align)) }
}

#[cfg(not(test))]
#[no_mangle]
pub unsafe extern "C" fn __rust_c_dealloc(ptr: *mut u8, size: usize, align: usize) {
    unsafe { crate::std::alloc::dealloc(ptr, Layout::from_size_align_unchecked(size, align)) }
}
