...
mod imp {
    ...
    use crate::std::ptr;
    use crate::std::sync::atomic::{AtomicIsize, AtomicPtr, Ordering};
    use dlibc;
...
mod imp {
    ...
    pub fn args() -> Args {
        ...
        extern "C" {
            ...
            fn _NSGetArgc() -> *mut dlibc::c_int;
            fn _NSGetArgv() -> *mut *mut *mut dlibc::c_char;
        }
    ...
    pub fn args() -> Args {
        ...
        extern "C" {
            fn sel_registerName(name: *const dlibc::c_uchar) -> Sel;
            fn objc_getClass(class_name: *const dlibc::c_uchar) -> NsId;
        }
        ...
        extern "C" {
            ...
            fn objc_msgSend_ul(obj: NsId, sel: Sel, i: dlibc::c_ulong) -> NsId;
        }
        ...
        type Sel = *const dlibc::c_void;
        type NsId = *const dlibc::c_void;
        ...
        unsafe {
            ...
            for i in 0..cnt {
                let tmp = objc_msgSend_ul(args, object_at_sel, i as dlibc::c_ulong);
                let utf_c_str: *const dlibc::c_char = mem::transmute(objc_msgSend(tmp, utf8_sel));
