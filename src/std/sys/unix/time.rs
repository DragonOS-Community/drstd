...
#[cfg(target_os = "nto")]
pub(super) const TIMESPEC_MAX_CAPPED: dlibc::timespec = dlibc::timespec {
...
pub struct SystemTime {
    pub(in crate::std::sys::unix) t: Timespec,
}

#[derive(Copy, Clone, PartialEq, Eq, PartialOrd, Ord, Hash)]
pub(in crate::std::sys::unix) struct Timespec {
    tv_sec: i64,
    tv_nsec: Nanoseconds,
}
...
impl Timespec {
    ...
    #[allow(dead_code)]
    pub fn to_timespec(&self) -> Option<dlibc::timespec> {
        Some(dlibc::timespec {
    ...
    // is 2^64 nanoseconds
    #[cfg(target_os = "nto")]
    pub(super) fn to_timespec_capped(&self) -> Option<dlibc::timespec> {
...
impl From<dlibc::timespec> for Timespec {
    fn from(t: dlibc::timespec) -> Timespec {
...
#[repr(C)]
pub(in crate::std::sys::unix) struct __timespec64 {
    pub(in crate::std::sys::unix) tv_sec: i64,
    #[cfg(target_endian = "big")]
    _padding: i32,
    pub(in crate::std::sys::unix) tv_nsec: i32,
...
mod inner {
    ...
    use crate::std::sys_common::mul_div_u64;
    use crate::std::time::Duration;
    ...
    type kern_return_t = dlibc::c_int;
    ...
    impl From<dlibc::timeval> for Timespec {
        fn from(t: dlibc::timeval) -> Timespec {
...
mod inner {
    ...
    impl Timespec {
        pub fn now(clock: dlibc::clockid_t) -> Timespec {
            ...
            ))]
            {
                ...
                weak!(fn __clock_gettime64(dlibc::clockid_t, *mut super::__timespec64) -> dlibc::c_int);
            ...
            let mut t = MaybeUninit::uninit();
            cvt(unsafe { dlibc::clock_gettime(clock, t.as_mut_ptr()) }).unwrap();
