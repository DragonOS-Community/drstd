...
use crate::std::fs::{File, Metadata};
use crate::std::io::copy::generic_copy;
use crate::std::io::{
...
use crate::std::os::unix::fs::FileTypeExt;
use crate::std::os::unix::io::{AsRawFd, FromRawFd, RawFd};
...
impl<R: CopyRead, W: CopyWrite> SpecCopy for Copier<'_, '_, R, W> {
    fn copy(self) -> Result<u64> {
        ...
        let mut flush = || -> crate::std::io::Result<u64> {
...
pub(super) fn copy_regular_files(reader: RawFd, writer: RawFd, max_len: u64) -> CopyResult {
    ...
    syscall! {
        fn copy_file_range(
            fd_in: dlibc::c_int,
            off_in: *mut dlibc::loff_t,
            fd_out: dlibc::c_int,
            off_out: *mut dlibc::loff_t,
            len: dlibc::size_t,
            flags: dlibc::c_uint
        ) -> dlibc::ssize_t
    }
...
fn sendfile_splice(mode: SpliceMode, reader: RawFd, writer: RawFd, len: u64) -> CopyResult {
    ...
    while written < len {
        ...
        let chunk_size = crate::std::cmp::min(len - written, 0x7ffff000_u64) as usize;
