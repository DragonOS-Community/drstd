...
use crate::std::io;
use crate::std::mem;
use crate::std::num::{NonZeroI32, NonZeroI64};
use crate::std::ptr;

use crate::std::sys::process::process_common::*;
use crate::std::sys::process::zircon::{zx_handle_t, Handle};
use dlibc;

use dlibc::{c_int, size_t};
...
impl Command {
    ...
    unsafe fn do_exec(
        ...
        use crate::std::sys::process::zircon::*;
    ...
    pub fn wait(&mut self) -> io::Result<ExitStatus> {
        ...
        unsafe {
            ...
            zx_cvt(zx_object_get_info(
                self.handle.raw(),
                ZX_INFO_PROCESS,
                &mut proc_info as *mut _ as *mut dlibc::c_void,
