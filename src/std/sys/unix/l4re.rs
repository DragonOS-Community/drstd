...
pub mod net {
    ...
    impl Socket {
        pub fn new(_: &SocketAddr, _: dlibc::c_int) -> io::Result<Socket> {
            unimpl!();
        }

        pub fn new_raw(_: dlibc::c_int, _: dlibc::c_int) -> io::Result<Socket> {
            unimpl!();
        }

        pub fn new_pair(_: dlibc::c_int, _: dlibc::c_int) -> io::Result<(Socket, Socket)> {
            unimpl!();
        }
        ...
        pub fn accept(
            &self,
            _: *mut dlibc::sockaddr,
            _: *mut dlibc::socklen_t,
        ) -> io::Result<Socket> {
            unimpl!();
        }
        ...
        pub fn set_timeout(&self, _: Option<Duration>, _: dlibc::c_int) -> io::Result<()> {
            unimpl!();
        }

        pub fn timeout(&self, _: dlibc::c_int) -> io::Result<Option<Duration>> {
            unimpl!();
        }
    ...
    pub struct LookupHost {
        original: *mut dlibc::addrinfo,
        cur: *mut dlibc::addrinfo,
    }
