...
use crate::std::sys;
use crate::std::sys::c;
use crate::std::sys_common::net;
use crate::std::sys_common::{AsInner, FromInner, IntoInner};
use crate::std::time::Duration;
use dlibc;
use dlibc::{c_int, c_long, c_ulong, c_ushort};

pub type wrlen_t = i32;

pub mod netc {
    pub use crate::std::sys::c::ADDRESS_FAMILY as sa_family_t;
    pub use crate::std::sys::c::ADDRINFOA as addrinfo;
    pub use crate::std::sys::c::SOCKADDR as sockaddr;
    pub use crate::std::sys::c::SOCKADDR_STORAGE_LH as sockaddr_storage;
    pub use crate::std::sys::c::*;
}
