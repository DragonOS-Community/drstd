...
use crate::std::os::windows::io::AsRawHandle;
use crate::std::os::windows::io::HandleOrNull;
use crate::std::ptr;
use crate::std::sys::c;
use crate::std::sys::handle::Handle;
use crate::std::sys::stack_overflow;
...
pub fn available_parallelism() -> io::Result<NonZeroUsize> {
    let res = unsafe {
        let mut sysinfo: c::SYSTEM_INFO = crate::std::mem::zeroed();
