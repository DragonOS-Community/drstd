...
use crate::std::sys::hashmap_random_keys;
...
impl AnonPipe {
    ...
    pub fn read(&self, buf: &mut [u8]) -> io::Result<usize> {
        let result = unsafe {
            let len = crate::std::cmp::min(buf.len(), c::DWORD::MAX as usize) as c::DWORD;
    ...
    pub fn read_buf(&self, mut buf: BorrowedCursor<'_>) -> io::Result<()> {
        let result = unsafe {
            let len = crate::std::cmp::min(buf.capacity(), c::DWORD::MAX as usize) as c::DWORD;
    ...
    unsafe fn alertable_io_internal(
        ...
        let mut overlapped: c::OVERLAPPED = crate::std::mem::zeroed();
