...
use crate::std::mem;
pub use crate::std::os::raw::c_int;
use crate::std::os::raw::{c_char, c_long, c_longlong, c_uint, c_ulong, c_ushort, c_void};
use crate::std::os::windows::io::{AsRawHandle, BorrowedHandle};
use crate::std::ptr;
...
pub unsafe fn NtReadFile(
    ...
    buffer: *mut crate::std::mem::MaybeUninit<u8>,
    length: ULONG,
...
compat_fn_optional! {
    crate::std::sys::compat::load_synch_functions();
