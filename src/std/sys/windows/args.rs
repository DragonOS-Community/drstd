...
use crate::std::fmt;
use crate::std::io;
use crate::std::num::NonZeroU16;
use crate::std::os::windows::prelude::*;
use crate::std::path::{Path, PathBuf};
use crate::std::sys::path::get_long_path;
use crate::std::sys::process::ensure_no_nuls;
use crate::std::sys::windows::os::current_exe;
use crate::std::sys::{c, to_u16s};
use crate::std::sys_common::wstr::WStrUnits;
use crate::std::vec;
...
pub(crate) fn from_wide_to_user_path(mut path: Vec<u16>) -> io::Result<Vec<u16>> {
    use crate::std::ptr;
    use crate::std::sys::windows::fill_utf16_buf;
