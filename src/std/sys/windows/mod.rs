...
pub fn to_u16s<S: AsRef<OsStr>>(s: S) -> crate::std::io::Result<Vec<u16>> {
    fn inner(s: &OsStr) -> crate::std::io::Result<Vec<u16>> {
...
fn fill_utf16_buf<F1, F2, T>(mut f1: F1, f2: F2) -> crate::std::io::Result<T>
where
    ...
    unsafe {
        ...
        loop {
            ...
            let k = match f1(buf.as_mut_ptr().cast::<u16>(), n as c::DWORD) {
                ...
                0 => return Err(crate::std::io::Error::last_os_error()),
                n => n,
            } as usize;
    ...
    unsafe {
        cfg_if::cfg_if! {
            if #[cfg(any(target_arch = "x86", target_arch = "x86_64"))] {
                ...
                crate::std::intrinsics::unreachable();
