...
pub const DEFAULT_MIN_STACK_SIZE: usize = 0x4000 * crate::std::mem::size_of::<usize>();
...
impl Thread {
    ...
    pub unsafe fn new(stack: usize, p: Box<dyn FnOnce()>) -> io::Result<Thread> {
        ...
        unsafe extern "C" fn trampoline(exinf: isize) {
            let p_inner: *mut ThreadInner = crate::std::ptr::from_exposed_addr_mut(exinf as usize);
...
pub fn available_parallelism() -> io::Result<crate::std::num::NonZeroUsize> {
    super::unsupported()
}
