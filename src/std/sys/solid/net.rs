...
pub fn cvt_gai(err: c_int) -> io::Result<()> {
    if err == 0 {
        ...
        let msg: &dyn crate::std::fmt::Display = match err {
...
pub fn is_interrupted(er: abi::ER) -> bool {
    er == netc::SOLID_NET_ERR_BASE - dlibc::EINTR
}

pub(super) fn decode_error_kind(er: abi::ER) -> ErrorKind {
    let errno = netc::SOLID_NET_ERR_BASE - er;
    match errno as dlibc::c_int {
        dlibc::ECONNREFUSED => ErrorKind::ConnectionRefused,
        dlibc::ECONNRESET => ErrorKind::ConnectionReset,
        dlibc::EPERM | dlibc::EACCES => ErrorKind::PermissionDenied,
        dlibc::EPIPE => ErrorKind::BrokenPipe,
        dlibc::ENOTCONN => ErrorKind::NotConnected,
        dlibc::ECONNABORTED => ErrorKind::ConnectionAborted,
        dlibc::EADDRNOTAVAIL => ErrorKind::AddrNotAvailable,
        dlibc::EADDRINUSE => ErrorKind::AddrInUse,
        dlibc::ENOENT => ErrorKind::NotFound,
        dlibc::EINTR => ErrorKind::Interrupted,
        dlibc::EINVAL => ErrorKind::InvalidInput,
        dlibc::ETIMEDOUT => ErrorKind::TimedOut,
        dlibc::EEXIST => ErrorKind::AlreadyExists,
        dlibc::ENOSYS => ErrorKind::Unsupported,
        dlibc::ENOMEM => ErrorKind::OutOfMemory,
        dlibc::EAGAIN => ErrorKind::WouldBlock,
